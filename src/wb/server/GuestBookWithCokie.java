...
@WebServlet(urlPatterns="/GuestBookWithCokie",loadOnStartup=1)
public class GuestBookWithCokie extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public GuestBookWithCokie() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</table>");
		out.println("<br>");
		out.println("<a href=SLAdd>Leave your message</a>");
		out.println("</body>");
		out.println("</html>");
	}
